...
export class DashboardComponent implements OnInit {
  ...
  total_ram:any;
  total_ram_consumida:any;
  porcentaje_consumo:any;
  ...
  ordenar(){
    for(let x = 0; x < this.lista.length - 1; x++){
  ...
  ngOnInit() {
    ...
    this.gradientStroke.addColorStop(0, 'blue');
    this.gradientStroke.addColorStop(1, this.chartColor);

    this.gradientFill = this.ctx.createLinearGradient(0, 200, 0, 50);
    this.gradientFill.addColorStop(0, "rgba(128, 182, 244, 0)");
    this.gradientFill.addColorStop(1, "blue");
    ...
    this.lineBigDashboardChartLabels = ["Leida N - 3", "Leida N - 2", "Leida N - 1", "Leida N"];
